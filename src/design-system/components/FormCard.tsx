...
export const FormCard: React.FC<FormCardProps> = ({
  ...
  return <div className={className}>
      {/* Hero Image */}
      {heroImage && <div className="overflow-hidden" style={{
      aspectRatio: '16/9',
      ...
      borderRadius: heroImage ? `0 0 ${designTokens.borderRadius.card} ${designTokens.borderRadius.card}` : designTokens.borderRadius.card,
